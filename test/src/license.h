...
#define RLM_COPYRIGHT  "Copyright (C) 2006-2025, Reprise Software, Inc. All rights reserved."
...
#define RLM_ID_ERR_FIRST 2001
#define RLM_ID_INVALID_CREDENTIALS -2001
#define RLM_ID_USER_DISABLED -2002
#define RLM_ID_NO_ISVNAME -2003
#define RLM_ID_INTERNAL_CURL -2004
#define RLM_ID_INTERNAL_CRYPTO -2005
#define RLM_ID_NO_SERVERS -2006
#define RLM_ID_ERR_LAST 6
...
#define RLM_SOFTWARE_VERSION  "Reprise License Manager (RLM) v17.0, Copyright (C) 2006-2025, Reprise Software, Inc."
...
extern int rlm_id_login(const char *email, const char* password);
/*
 *  RLM_LICENSE data
 */
