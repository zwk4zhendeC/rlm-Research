...
rlm.rlm_init.restype = c_ulonglong
...
rlm.rlm_checkout.argtypes= [ c_ulonglong, c_char_p, c_char_p, c_int ]
rlm.rlm_checkout.restype = c_ulonglong

rlm.rlm_stat.argtypes = [ c_ulonglong ] 
rlm.rlm_stat.restype = c_int

rlm.rlm_license_stat.argtypes = [ c_ulonglong ]
rlm.rlm_license_stat.restype = c_int

rlm.rlm_checkin.argtypes = [ c_ulonglong ]
rlm.rlm_checkin.restype = c_int

rlm.rlm_close.argtypes = [ c_ulonglong ]
rlm.rlm_close.restype = c_int


rlm.rlm_errstring.argtypes= [ c_ulonglong, c_ulonglong, c_char_p ]
...
product=b"test"
version=b"1.0"
lic=rlm.rlm_checkout(rh, product, version, c_int(1))
